...
if(notEmpty($data->funcionario_id) and notEmpty($data->hora_saida) ){
	$create = $frequencia->update(array("hora_saida"=>$data->hora_saida),"funcionario_id={$data->funcionario_id}");
	if($create){
